...
public class UtilProperties {
    ...
    public static boolean setMessage(String fichero, String key, String value){
    	
    	Properties objProperties = new Properties();
    	boolean booResultado = false;
    	try {
    		
    		InputStream objInputStream = new FileInputStream(fichero);
    		objProperties.load(objInputStream);
    		objInputStream.close();
    		
    		objProperties.setProperty(key,value);
    		objProperties.store(new FileOutputStream(fichero),null);
    		
    		System.out.println("El archivo "+fichero+" ha sido grabado exitosamente");

    		booResultado = true;
    	} catch (Exception e) {e.printStackTrace();	booResultado = false;}
    	return booResultado;
